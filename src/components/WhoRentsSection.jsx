        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 w-full max-w-5xl 2xl:max-w-7xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-full hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-slate-900 leading-tight">Rideshare Professionals</h3>
            </div>
            ...
            <button className="w-full py-3 px-4 border border-slate-300 rounded-lg font-button text-slate-700 hover:border-primary hover:text-primary transition-colors flex justify-center items-center gap-2">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-full hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-slate-900 leading-tight">Delivery Drivers</h3>
            </div>
            <p className="text-slate-600 mb-8 flex-grow">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-full hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-slate-900 leading-tight">Personal & Family Use</h3>
            </div>
            <p className="text-slate-600 mb-8 flex-grow">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 flex flex-col h-full hover:shadow-md transition-shadow">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h3 className="text-2xl font-bold text-slate-900 leading-tight">Temporary Replacements</h3>
            </div>
            <p className="text-slate-600 mb-8 flex-grow">
